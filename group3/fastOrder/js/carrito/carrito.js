class Carrito {
    ...
    comprarProducto(e){
        ...
        if(e.target.classList.contains('agregar-carrito')){
            ...
            //console.log("Producto: "+producto+" ... "+producto.querySelector('.featured__item__pic.set-bg'));
    ...
    leerDatosProducto(producto){
        const infoProducto = {
            imagen : producto.querySelector('.featured__item__pic.set-bg').getAttribute('data-setbg'),
            titulo: producto.querySelector('h6').textContent,
            precio: producto.querySelector('.precio span').textContent,
            id: producto.querySelector('.featured__item__pic.set-bg').getAttribute('data-id'),
            cantidad: 1
        }
        let productosLS;
        ...
        productosLS.forEach(function (producto){
            ...
            row.innerHTML = `
                ...
                <td class="shoping__cart__item__close">
                    <a href="#" class="icon_close" style="font-size:30px" data-id="${producto.id}"></a>
                </td>
            `;
